...
import stylesCss from 'themes/graphqlapp/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_graphqlapp_componentCss']) {
    
    document['_vaadintheme_graphqlapp_componentCss'] = true;
  }
